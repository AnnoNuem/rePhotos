def pst(image, lpf=0.5, phase_strength=0.1, warp_strength=0.5, thresh_min=-0.3, thresh_max=0.3, morph_flag=False):
    ...
    if morph_flag == False:
        ...
        thresh_neg = 1.66 * mean_neg
        thresh_pos = 1.66 * mean_pos
